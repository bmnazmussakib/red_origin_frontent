    ...
    var EZP = {
        ...
        startZoom: function () {
            ...
            if (self.options.imageCrossfade) {
                var elementZoomWrapper = $('<div className="zoomWrapper"/>')
                    .css({
            ...
            function getInnerZoomStyle() {
                ...
                if (self.options.scrollZoom)
                    self.zoomLens = $('<div className="zoomLens"/>');
            ...
            self.zoomContainer = $('<div className="' + self.options.container + '" ' + 'uuid="' + self.options.zoomId + '"/>');
            ...
            if (self.options.zoomType !== 'inner') {
                ...
                if (self.options.tint) {
                    self.tintContainer = $('<div className="tintContainer"/>');
                    self.zoomTint = $('<div className="zoomTint"/>').css(self.tintStyle);
            ...
            self.zoomWindow = $('<div className="zoomWindow"/>')
                .css($.extend({
                    zIndex: 999,
            ...
            self.zoomWindowContainer = $('<div className="zoomWindowContainer" />')
                .css({
                    width: self.options.zoomWindowWidth
                });
        ...
        swaptheimage: function (smallimage, largeimage) {
            ...
            if (self.options.loadingIcon && !self.spinner) {
                ...
                self.spinner = $('<div className="ezp-spinner"></div>')
                  .css(styleAttr);
